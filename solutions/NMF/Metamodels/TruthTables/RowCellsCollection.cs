...
namespace TTC2019.BinaryDecision.Metamodels.TruthTables.TT
{
    ...
    public class RowCellsCollection : ObservableOppositeOrderedSet<IRow, ICell>
    {
        
        public RowCellsCollection(IRow parent) : 
                base(parent)
        {
        }
        ...
        private void OnItemParentChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                this.Remove(((ICell)(sender)));
            }
        }
        
        protected override void SetOpposite(ICell item, IRow parent)
        {
            if ((parent != null))
            {
