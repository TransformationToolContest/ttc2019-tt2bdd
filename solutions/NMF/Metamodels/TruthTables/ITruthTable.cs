...
namespace TTC2019.BinaryDecision.Metamodels.TruthTables.TT
{
    ...
    /// <summary>
    /// The public interface for TruthTable
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(TruthTable))]
    [XmlDefaultImplementationTypeAttribute(typeof(TruthTable))]
    [ModelRepresentationClassAttribute("https://www.transformation-tool-contest.eu/2019/tt#//TruthTable")]
    public interface ITruthTable : IModelElement, ILocatedElement
    {
        ...
        [XmlOppositeAttribute("owner")]
        [ConstantAttribute()]
        IOrderedSetExpression<IRow> Rows
        {
            get;
        }
