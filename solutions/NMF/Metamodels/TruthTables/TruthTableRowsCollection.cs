...
namespace TTC2019.BinaryDecision.Metamodels.TruthTables.TT
{
    ...
    public class TruthTableRowsCollection : ObservableOppositeOrderedSet<ITruthTable, IRow>
    {
        
        public TruthTableRowsCollection(ITruthTable parent) : 
                base(parent)
        {
        }
        ...
        private void OnItemParentChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                this.Remove(((IRow)(sender)));
            }
        }
        
        protected override void SetOpposite(IRow item, ITruthTable parent)
        {
            if ((parent != null))
            {
