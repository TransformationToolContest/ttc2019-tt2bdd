...
namespace TTC2019.BinaryDecision.Metamodels.BinaryDecisionDiagrams.BDD
{
    ...
    /// <summary>
    /// The default implementation of the Leaf class
    /// </summary>
    [XmlNamespaceAttribute("https://www.transformation-tool-contest.eu/2019/bdd")]
    [XmlNamespacePrefixAttribute("bdd")]
    [ModelRepresentationClassAttribute("https://www.transformation-tool-contest.eu/2019/bdd#//Leaf")]
    public partial class Leaf : Tree, ILeaf, IModelElement
    {
        ...
        /// </summary>
        private LeafAssignmentsCollection _assignments;
        
        private static IClass _classInstance;
        
        public Leaf()
        {
            this._assignments = new LeafAssignmentsCollection(this);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IAssignment> Assignments
        {
            get
            {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new LeafChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new LeafReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("https://www.transformation-tool-contest.eu/2019/bdd#//Leaf")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Leaf.ClassInstance)).Resolve("assignments")));
        }
        ...
        {
            int assignmentsIndex = ModelHelper.IndexOfReference(this.Assignments, element);
            if ((assignmentsIndex != -1))
            {
                return ModelHelper.CreatePath("assignments", assignmentsIndex);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                if ((index < this.Assignments.Count))
                {
        ...
        {
            if ((container == this._assignments))
            {
                return "assignments";
            }
        ...
        /// <summary>
        /// The collection class to to represent the children of the Leaf class
        /// </summary>
        public class LeafChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ILeaf _parent;
        ...
        /// The collection class to to represent the children of the Leaf class
        /// </summary>
        public class LeafReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
