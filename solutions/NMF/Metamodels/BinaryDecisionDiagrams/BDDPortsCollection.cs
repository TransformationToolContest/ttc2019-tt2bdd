...
namespace TTC2019.BinaryDecision.Metamodels.BinaryDecisionDiagrams.BDD
{
    ...
    public class BDDPortsCollection : ObservableOppositeOrderedSet<IBDD, IPort>
    {
        
        public BDDPortsCollection(IBDD parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IPort item, IBDD parent)
        {
            if ((parent != null))
            {
