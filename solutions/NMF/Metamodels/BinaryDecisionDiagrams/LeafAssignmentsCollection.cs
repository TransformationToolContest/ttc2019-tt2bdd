...
namespace TTC2019.BinaryDecision.Metamodels.BinaryDecisionDiagrams.BDD
{
    ...
    public class LeafAssignmentsCollection : ObservableOppositeOrderedSet<ILeaf, IAssignment>
    {
        
        public LeafAssignmentsCollection(ILeaf parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IAssignment item, ILeaf parent)
        {
            if ((parent != null))
            {
