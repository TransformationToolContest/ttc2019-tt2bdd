...
import ttc2019.bdd.InputPort;
import ttc2019.bdd.Leaf;
import ttc2019.bdd.OutputPort;
import ttc2019.bdd.Port;
import ttc2019.bdd.Subtree;
import ttc2019.bdd.Tree;
...
public class BDDPackageImpl extends EPackageImpl implements BDDPackage {
	 ...
	 * @see ttc2019.bdd.BDDPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(bddEClass, ttc2019.bdd.BDD.class, "BDD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBDD_Name(), ecorePackage.getEString(), "name", null, 1, 1, ttc2019.bdd.BDD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getBDD_Ports(), this.getPort(), this.getPort_Owner(), "ports", null, 1, -1, ttc2019.bdd.BDD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getBDD_Tree(), this.getTree(), this.getTree_OwnerBDD(), "tree", null, 1, 1, ttc2019.bdd.BDD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
