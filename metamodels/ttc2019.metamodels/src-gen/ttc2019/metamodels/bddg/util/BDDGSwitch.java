 ...
 * @generated
 */
public class BDDGSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BDDGPackage.BDD: {
				BDD bdd = (BDD)theEObject;
				T result = caseBDD(bdd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDGPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDGPackage.INPUT_PORT: {
			...
			case BDDGPackage.ASSIGNMENT: {
				Assignment assignment = (Assignment)theEObject;
				T result = caseAssignment(assignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BDDGPackage.SUBTREE: {
